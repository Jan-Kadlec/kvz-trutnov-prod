...
export default function Header({ onNavigate, currentSection }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-military-900/95 backdrop-blur-sm border-b border-olive-800 z-50">  <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
